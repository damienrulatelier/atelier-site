...
const CATEGORIES: { key: CategoryKey; title: string; description: string }[] = [
  ...
  },
  {
    key: "surmesure",
    title: "Sur mesure",
    description: "Peinture, illustration, multi-pages, œuvre digitale de toute sorte, commande longue durée, projet hybride… Tout ce qui ne rentre pas dans les catégories ci-dessus. Décris ton projet, on construit ensemble le tarif et le planning.",
  },
  {
    key: "provisuel",
    title: "Projet visuel",
